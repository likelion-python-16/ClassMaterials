...
def find_reivew_article(location: str, keyword: str):
    ...
    # https://search.naver.com/search.naver?sm=tab_hty.top&ssc=tab.blog.all&query=서울청년센터+강북오랑
    # https://search.naver.com/search.naver	네이버 통합검색의 기본 주소
    # ?sm=tab_hty.top	검색 방식 지정 (UI 클릭 또는 주소창 직접 검색 등)
    # &ssc=tab.blog.all	검색 탭을 블로그로 설정
    # &query=...	실제 검색어 입력 부분
